...
#define _URAND31() ((rand() & 0x7FFFFFFF))
#define _RAND32() ((int)(rand() & 1 ? _URAND31() : -_URAND31() - 1))

#define _URAND15() ((rand() & 0x7FFF))
#define _RAND16() ((short)(rand() & 1 ? _URAND15() : -_URAND15() - 1))

#define _URAND9() ((rand() & 0x3FF))
#define _RAND10() ((short)(rand() & 1 ? _URAND9() : -_URAND9() - 1))

// ClusterTag. [-1023, -100] || [100, 1023]
#define _RAND10_AVOID_SMALL() \
    ({ \
        short r; \
        do { \
            r = _RAND10(); \
