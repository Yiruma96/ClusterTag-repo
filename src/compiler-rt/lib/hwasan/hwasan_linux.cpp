...
#  endif
  ...
  if (has_abi) {
#  if SANITIZER_ANDROID || defined(HWASAN_ALIASING_MODE) || defined(__x86_64__)
...
bool InitShadow() {
  ...
  kHighMemStart = kHighShadowEnd;

  ReserveShadowMemoryRange(kLowShadowStart, kHighShadowEnd, "ClusterTag Shadow Mem");
