...
void LoadedModule::clear() {
  ...
  CTPersistentAllocatorFree(&ct_persistent_allocator, (uptr)full_name_, 1);
  base_address_ = 0;
  max_address_ = 0;
  full_name_ = nullptr;
  ...
  while (!ranges_.empty()) {
    ...
    // InternalFree(r);
    // ClusterTag. Use our persistent allocator
    CTPersistentAllocatorFree(&ct_persistent_allocator, (uptr)r, 1);
  }
}
...
void LoadedModule::addAddressRange(uptr beg, uptr end, bool executable,
  ...
  // ClusterTag. Use our persistent allocator
  void *mem = (void*)CTPersistentAllocatorAllocate(&ct_persistent_allocator, sizeof(AddressRange));
  AddressRange *r =
